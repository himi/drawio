...
(function()
{
    ...
    Menus.prototype.init = function()
    {
        ...
        editorUi.actions.put('exportSysmlSymbols', new Action('SysML symbols (PNG & SVG)', function()
        {
            editorUi.exportSysmlSymbols();
        }));
        ...
        this.put('exportAs', new Menu(mxUtils.bind(this, function(menu, parent)
        {
            ...
            this.addMenuItems(menu, ['exportSysmlSymbols', '-'], parent);
